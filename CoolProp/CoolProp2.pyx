...
cpdef Props(bytes in1, bytes in2, in3=None, in4=None,in5=None,in6=None):
    """
    Call Type #1::
...
cpdef DerivTerms(bytes Output, double T, double rho, bytes Fluid):
    """
...
cpdef bytes Phase(bytes Fluid, double T, double p):
    """
...
cpdef SaturationLUTStatus(bint OnOff):
    """
...
cpdef SinglePhaseLUTStatus(bint OnOff):
    """
...
cpdef bytes get_REFPROPname(bytes Fluid):
    """
