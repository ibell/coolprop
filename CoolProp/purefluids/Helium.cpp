...
HeliumClass::HeliumClass()
{
	...
	phi_BC * phirg_ = new phir_gaussian(n_v,d_v,t_v,alpha_v,epsilon_v,beta_v,gamma_v,13,21);
...
{
	return 0.389057*(1-T/reduce.T)+0.521410*pow(1-T/reduce.T,2)-0.579737*pow(1-T/reduce.T,3);
}