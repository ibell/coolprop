...
{
    // Maximum absolute error is 0.072073 % between 92.000000 K and 301.999990 K
    const double t[]={0, 1, 2, 3, 5, 8, 13, 20};
    const double N[]={0, -0.012158915459893265, -6.8155490046233229, 1.5332168462222784, -1.6079015781776091, -1.2428918515532328, -2.0861003439654531, 1.3362440207501194};
    double summer=0,theta;
    theta=1-T/reduce.T;
    for (int i=1;i<=6;i++)
    {
...
{
    // Maximum absolute error is 0.068970 % between 92.000000 K and 301.999990 K
    const double t[] = {0, 0.6666666666666666, 0.8333333333333334, 1.0, 1.1666666666666667, 1.3333333333333333, 1.6666666666666667};
    const double N[] = {0, 68.866476240390099, -308.12026186907696, 606.23492385090003, -596.68612879623015, 255.14368018942633, -22.765754347277113};
    double summer=0,theta;
    theta=1-T/reduce.T;
...
{
    // Maximum absolute error is 0.324630 % between 92.000000 K and 301.999990 K
    const double t[] = {0, 0.3333333333333333, 0.5, 0.6666666666666666, 0.8333333333333334, 1.0, 1.1666666666666667, 1.5, 1.6666666666666667, 2.1666666666666665};
    const double N[] = {0, -6.396116293939631, 179.63685642906529, -1510.5289524169891, 5664.9202948676884, -10897.747749417214, 9669.6540294473052, -6678.1407343242263, 3840.8366588413942, -271.30999150872293};
    double summer=0,theta;
    theta=1-T/reduce.T;
