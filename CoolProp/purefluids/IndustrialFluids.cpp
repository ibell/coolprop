...
double R245faClass::viscosity_Trho(double T, double rho)
{
    ...
    double f1 = -2.448885643218865e-11, g1 = 1.01776492967349, g2 = 0.9691763338719738;
    for (int i=0;i<=5;i++){ for(int j=0;j<=2;j++){ e[i][j]=0.0; } }
    e[2][0] = -0.003222444968127644; e[2][1] = 0.006709766215343659; e[2][2] = -0.003486504407268922; 
	e[3][0] = 0.005140576164778369; e[3][1] = -0.01007713716955905; e[3][2] = 0.005002087995076177; 
	e[4][0] = -0.002506430209069247; e[4][1] = 0.004680911453620516; e[4][2] = -0.002231143600665872; 
	e[5][0] = 0.0003905081468031243; e[5][1] = -0.0006926924721780241; e[5][2] = 0.000317915317683606; 
