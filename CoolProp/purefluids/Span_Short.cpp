...
{
	// Max error is  0.602312068961 % between 162.68 and 471.0599 K

    const double ti[]={0, 0.051000000000000004, 0.062, 0.066, 0.083, 0.11800000000000001, 0.14100000000000001, 0.3585, 0.371, 0.39299999999999996, 0.39449999999999996, 0.5, 0.6666666666666666};
    const double Ni[]={0, -129480867429.48401, 1278852190365.0867, -1434626279059.2637, 360360672735.66156, -122658793993.60068, 48983384552.023308, -233863404720.80826, 517891888691.43195, -2696379700374.3936, 2411610140819.7222, -694900764.41820669, 5669181.1219745446};
    double summer=0;
    int i;
    double theta;
    theta=1-T/reduce.T;
