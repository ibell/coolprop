...
Triple Point Temp. [K]     2.177
Triple Point Press. [kPa]  5.055134771
Minimum temperature [K]    2.177
=========================  ==============================
...
.. plot::
    ...
    Ph(Ref, axis = ax1, Tmin = Tmin, Tmax = 5.185300)
    Ps(Ref, axis = ax2, Tmin = Tmin, Tmax = 5.185300)
    hs(Ref, axis = ax3, Tmin = Tmin, Tmax = 5.185300)
