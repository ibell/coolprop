...
=========================
**Equation of State**: R. Tillner-Roth and A. Yokozeki, 1997, An international standard equation of state for difluoromethane (R-32) for temperatures from the triple point at 136.34 K to 435 K and pressures up to 70 MPa, *J. Phys. Chem. Ref. Data*, 26:1273-1328
...
**Lennard-Jones Parameters for ECS**: Mark O. McLinden and Sanford A. Klein and Richard A. Perkins, 2000, An extended corresponding states model for the thermal conductivity of refrigerants and refrigerant mixtures, *Int. J. Refrig.*, 23:43-63

**ECS Correction Fit**: Mark O. McLinden and Sanford A. Klein and Richard A. Perkins, 2000, An extended corresponding states model for the thermal conductivity of refrigerants and refrigerant mixtures, *Int. J. Refrig.*, 23:43-63
...
Triple Point Temp. [K]     136.340
Triple Point Press. [kPa]  0.04800738251
Minimum temperature [K]    136.340
=========================  ==============================

Critical Parameters

==============================  ==============================
Temperature [K]                 351.255
...
.. plot::
    ...
    Ph(Ref, axis = ax1, Tmin = Tmin, Tmax = 351.245000)
    Ps(Ref, axis = ax2, Tmin = Tmin, Tmax = 351.245000)
    hs(Ref, axis = ax3, Tmin = Tmin, Tmax = 351.245000)
