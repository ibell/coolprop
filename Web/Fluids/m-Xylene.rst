...
Triple Point Press. [kPa]  0.003123267842
...
.. plot::
    ...
    Ph(Ref, axis = ax1, Tmin = Tmin, Tmax = 616.880000)
    Ps(Ref, axis = ax2, Tmin = Tmin, Tmax = 616.880000)
    hs(Ref, axis = ax3, Tmin = Tmin, Tmax = 616.880000)
