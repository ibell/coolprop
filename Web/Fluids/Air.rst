...
=========================
**Equation of State**: Eric Lemmon and Richard T. Jacobsen and Steven G. Penoncello and Daniel Friend, 2000, Thermodynamic Properties of Air and Mixtures of Nitrogen, Argon, and Oxygen from 60 to 2000 K at Pressures to 2000 MPa, *J. Phys. Chem. Ref. Data*, 29:331-385
...
Triple Point Temp. [K]     59.750
Triple Point Press. [kPa]  2.445823523
Minimum temperature [K]    59.750
=========================  ==============================

Critical Parameters

==============================  ==============================
Temperature [K]                 132.531
...
.. plot::
    ...
    Ph(Ref, axis = ax1, Tmin = Tmin, Tmax = 132.520600)
    Ps(Ref, axis = ax2, Tmin = Tmin, Tmax = 132.520600)
    hs(Ref, axis = ax3, Tmin = Tmin, Tmax = 132.520600)
