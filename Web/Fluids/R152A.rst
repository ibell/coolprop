...
Triple Point Press. [kPa]  76.64304213
...
.. plot::
    ...
    Ph(Ref, axis = ax1, Tmin = Tmin, Tmax = 386.400000)
    Ps(Ref, axis = ax2, Tmin = Tmin, Tmax = 386.400000)
    hs(Ref, axis = ax3, Tmin = Tmin, Tmax = 386.400000)
