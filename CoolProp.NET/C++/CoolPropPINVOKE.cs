...
class CoolPropPINVOKE {
  ...
  public static extern double Props__SWIG_0(string jarg1, char jarg2, double jarg3, char jarg4, double jarg5, string jarg6);

  [DllImport("CoolProp", EntryPoint="CSharp_Props1__SWIG_0")]
  public static extern double Props1__SWIG_0(string jarg1, string jarg2);
  ...
  public static extern double Props__SWIG_1(string jarg1, string jarg2);

  [DllImport("CoolProp", EntryPoint="CSharp_set_1phase_LUT_params__SWIG_2")]
  public static extern int set_1phase_LUT_params__SWIG_2(string jarg1, int jarg2, int jarg3, double jarg4, double jarg5, double jarg6, double jarg7);
