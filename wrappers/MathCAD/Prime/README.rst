...
* The mcaduser.lib and mcadincl.h files from MathCAD need to be included and linked when building the “CoolProp 4.0 Beta Mathcad Prime 3.0 Wrapper.cpp” file.  If you have Mathcad Prime 3.0 installed, the default location of the compiled DLL is: C:\Program Files\PTC\Mathcad Prime 3.0\Custom Functions
