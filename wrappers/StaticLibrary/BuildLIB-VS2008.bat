...
cl /c /MP4 /I../../CoolProp /EHsc /MDd ../../CoolProp/*.cpp
lib *.obj /OUT:VS2008/CoolPropLib_MDd.lib
erase *.obj

REM ******* compile all the sources from CoolProp ***************
cl /c /MP4 /I../../CoolProp /EHsc /MD ../../CoolProp/*.cpp
lib *.obj /OUT:VS2008/CoolPropLib_MD.lib
erase *.obj

REM ******* compile all the sources from CoolProp ***************
cl /c /MP4 /I../../CoolProp /EHsc /MT ../../CoolProp/*.cpp
lib *.obj /OUT:VS2008/CoolPropLib_MT.lib
erase *.obj

REM ******* compile all the sources from CoolProp ***************
cl /c /MP4 /I../../CoolProp /EHsc /MTd ../../CoolProp/*.cpp
