...
extern "C" DLLEXPORT int Props( WolframLibraryData libData, mint Argc, MArgument *Args, MArgument Res) {
	...
	double val = PropsS(outstring,In1string,(double)In1val,In2string,(double)In2val,Fluidstring);
