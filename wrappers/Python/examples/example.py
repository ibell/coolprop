...
p = CP.Props('P','T',300,'D',1,'Propane'); h = CP.Props('H','T',300,'D',1,'Propane');
print 'T,D -> P,H', 300,',',1, '-->',p,',',h
T = CP.Props('T','P',p,'H',h,'Propane'); D = CP.Props('D','P',p,'H',h,'Propane');
...
try:
    ...
    print ' '
    print 'TWO PHASE INPUTS (Pressure)'
    print 'Density of saturated liquid Propane at 101.325 kPa:', CP.Props('D','P',101.325,'Q',0,'REFPROP-Propane'), 'kg/m^3'
    print 'Density of saturated vapor Propane at 101.325 kPa:', CP.Props('D','P',101.325,'Q',1,'REFPROP-propane'), 'kg/m^3'
    print 'TWO PHASE INPUTS (Temperature)'
    print 'Density of saturated liquid Propane at 300 K:', CP.Props('D','T',300,'Q',0,'REFPROP-propane'), 'kg/m^3'
    print 'Density of saturated vapor Propane at 300 K:', CP.Props('D','T',300,'Q',1,'REFPROP-propane'), 'kg/m^3'
    print 'SINGLE PHASE CYCLE (propane)'
    p = CP.Props('P','T',300,'D',1,'Propane'); h = CP.Props('H','T',300,'D',1,'Propane');
    print 'T,D -> P,H', 300,',',1, '-->',p,',',h
    T = CP.Props('T','P',p,'H',h,'Propane'); D = CP.Props('D','P',p,'H',h,'Propane');
...
print ' '
print 'Density of 50% (mass) ethylene glycol/water at 300 K, 101.325 kPa:', CP.Props('D','T',300,'P',101.325,'EG-50%'), 'kg/m^3'
print 'Viscosity of Therminol D12 at 350 K, 101.325 kPa:', CP.Props('V', 'T', 350, 'P', 101.325, 'TD12'), 'Pa-s'
...
print 'Relative humidity from last calculation:', CP.HAProps('R','T',300,'P',101.325,'W',CP.HAProps('W','T',300,'P',101.325,'R',0.5)), '(fractional)'
