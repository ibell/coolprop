...
def params_constants():
    fName = os.path.join('..','..','CoolProp','CoolProp.h')
    ...
    if the_line is None:
        ...
        shutil.copy2('param_constants_header.pxd',os.path.join('..','..','CoolProp','param_constants_header.pxd'))
        shutil.copy2('param_constants.pyx',os.path.join('..','..','CoolProp','param_constants.pyx'))
...
def phase_constants():
    ...
    if the_line is None:
        ...
        shutil.copy2('phase_constants_header.pxd',os.path.join('..','..','CoolProp','phase_constants_header.pxd'))
        shutil.copy2('phase_constants.pyx',os.path.join('..','..','CoolProp','phase_constants.pyx'))
